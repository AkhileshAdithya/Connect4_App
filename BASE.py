...
class Connect4():
    ...
    def get_board_string(self, state):
        return np.flip(state, 0).tostring()
...
#         player1 = 1
#         player2 = 2
#         algo1 = MCTS(game, 100, player1) #change back to 200
#         algo2 = MCTS(game, 1000, player2) #change back to 40
#         MOVES = 0
